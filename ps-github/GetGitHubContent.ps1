Function GetGitHubContent {
    ...
    .DESCRIPTION
    This function enables you to download single or multiple files/directories directly from GitHub using various authentication methods.
    ...
    .EXAMPLE
    Get-GitHubContent -Owner "your_GitHub_name" -Repository "your_repo_name" -Branch "your_branch" -AuthToken "ghp_xyz" -Paths "your_repo_folder/your_file_on_GitHub.ps1"
    "ghp_xyz" | Get-GitHubContent -Owner "your_GitHub_name" -Repository "your_repo_name" -Branch "your_branch" -Paths "your_repo_folder/your_file_1.ps1", "your_repo_folder/your_file_2.ps1"
